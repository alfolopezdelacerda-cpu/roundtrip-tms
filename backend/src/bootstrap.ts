...
/**
 * Configuración común de la app Nest: seguridad, validación, CORS.
 *
 * La comparten `main.ts` (servidor tradicional, `app.listen`) y
 * `api/index.ts` (función serverless de Vercel, `app.init` sin `.listen`) —
 * así ninguno de los dos modos de arranque puede desincronizarse del otro.
 */
